...
```
* * * * * ubuntu bash /home/ubuntu/apps/archieml_test/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|archieml-test|tweet|`location`||
|archieml-test|facebook|`location`||
|archieml-test|email|`location`||
|archieml-test|new-comment||
|archieml-test|open-share-discuss||
|archieml-test|close-share-discuss||
|archieml-test|summary-copied||
|archieml-test|featured-tweet-action|`action`|
|archieml-test|featured-facebook-action|`action`|
